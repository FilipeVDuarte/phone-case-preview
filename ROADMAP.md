...
Um personalizador interativo de capinhas de smartphone desenvolvido para a **Mobifans**. Este projeto permite que usuários visualizem em tempo real como imagens ou fotos ficariam aplicadas em diferentes modelos de aparelhos, oferecendo uma experiência de compra imersiva e personalizada.
...
### **v1.5** — Suporte a Câmeras & Máscaras Avançadas
